...
#define DESCRACKER_IP_CONTROL_OFFSET              1*4
...
#define DESCRACKER_IP_STARTKEY_HIGH_OFFSET        16*4
#define DESCRACKER_IP_STARTKEY_LOW_OFFSET         17*4
#define DESCRACKER_IP_ENDKEY_HIGH_OFFSET          18*4
#define DESCRACKER_IP_ENDKEY_LOW_OFFSET           19*4
#define DESCRACKER_IP_MATCHOUT_HIGH_OFFSET        20*4
#define DESCRACKER_IP_MATCHOUT_LOW_OFFSET         21*4
...
#define DESCRAKER_IP_CONTROL_NOTRESET_DISABLED  0b00
#define DESCRAKER_IP_CONTROL_NOTRESET_ENABLED   0b01
#define DESCRAKER_IP_CONTROL_RESET_DISABLED     0b10
#define DESCRAKER_IP_CONTROL_RESET_ENABLED      0b11
